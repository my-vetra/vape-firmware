...
//         struct phaseModel pm; 
//         pm.phaseIndex = i; 
//         pm.duration = {0, 0}; 
//         pm.maxPuffs = MAX_PUFFS; 
//         pm.puffs_taken = 0; 
//         pm.id = pm.phaseIndex; 
//         phases[i] = pm; 
//     }
//     curr_phase.phase_index = 0; 
//     // Need to replace this with current date
//     curr_phase.phase_start_date = {0, 0, 0}; 
// }
...
//     switch(current_state){
//         case(WAIT):
//             struct phaseModel pm = phases[curr_phase.phase_index]; 
//             pm.puffs_taken = 0; 
//             pm.duration.start = 0; 
//             current_state = PUFF_COUNTING; 
//         break; 
